...
bot = telebot.TeleBot('7815465728:AAED1YXsX3-lgMShGfqVIOAMRXnSouvZpvs')
...
def process_attack(message, target, port, time):
    ...
    if user_data.get(user_id, {}).get('coins', 0) < 10:
...
def handle_buy_coins(message):
    ...
    if user_id in admin_id:
        ...
        bot.reply_to(message, "💰 𝗗𝗠 𝗧𝗢 𝗕𝗨𝗬 𝗖𝗢𝗜𝗡𝗦 @M_o_Y_007")
